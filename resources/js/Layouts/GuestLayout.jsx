        ...
        <>
            <div className={style["welcome-navbar-container"]}>
                <div className={style["welcome-navbar-front-div"]}>
                    ...
                    <div className={style["welcome-navbar-icons1"]}><img src="icons/contact.ico"></img>Contact</div>
                    <div className={style["welcome-navbar-icons1"]}><img src="icons/help.ico"></img>Need help</div>
                </div>
